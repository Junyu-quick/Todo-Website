        ...
        .then(data => {
            ...
            const noteLineHTML = 
                ...
                <div class="work-note-content">
                    <input class="edit-non-work-desc-input" type="text" value="${work.task}">
                </div>
                <div class="work-note-eta">
                    <input class="edit-non-work-eta-input" type="text" value="${work.eta}">
                </div>
...
workNoteElement.addEventListener('input', (event) => {
    ...
    inputTimeOutId = setTimeout(() => {
        ...
        fetch('http://localhost/tasks/updatework', {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "x-auth-token": jwt
...
nonWorkNoteElement.addEventListener('input', (event) => {
    ...
    fetch('http://localhost/tasks/updatenonwork', {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            "x-auth-token": jwt
